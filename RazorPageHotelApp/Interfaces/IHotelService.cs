...
namespace RazorPageHotelApp.Interfaces
{
    public interface IHotelService
    {
        ...
        /// /// <param name="roomsInHotel">Antallet af værelser tilknyttet hotellet så vi kan se om det må/kan slettes</param>
        /// <returns>Det hotel der er slettet fra databasen, returnere null hvis hotellet ikke findes</returns>
        Task<Hotel> DeleteHotelAsync(int hotelNr, List<Room> roomsInHotel);
